        ...
        implements GetFieldDataHandler
{
            ...
            List<Header> headers)
    {
        if ( fieldDataCriteria.getFilter() instanceof FieldFilter )
        {
            ...
            if ( !this.fieldFilterProessor.validateFieldFilter(fieldDataCriteria) ) 
            	return null;
        ...
        else if ( fieldDataCriteria.getFilter() instanceof FieldTypeFilter )
        {
            ...
            if ( !this.fieldTypeFilterProcessor.validateFieldTypeFilter((FieldTypeFilter) fieldDataCriteria.getFilter()))
            	return null;
