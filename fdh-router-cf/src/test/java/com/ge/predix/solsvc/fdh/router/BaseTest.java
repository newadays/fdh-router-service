...
import com.ge.predix.entity.osa.filter.TimeFilter;
import com.ge.predix.entity.osa.filter.TimeOffsetUnits;
import com.ge.predix.entity.osa.filter.TimeOrRowFilter;
...
public abstract class BaseTest
{
            ...
            throws UnsupportedEncodingException, IOException, HttpException, JAXBException
    {
        ...
        models.add(model);
        String body = this.jsonMapper.toJson(models);
        //String body = "[{\"complexType\":\"Model\",\"description\":\"desc\",\"additionalAttributes\":{\"complexType\":[\"Map\"],\"keys\":[\"key\"],\"values\":[\"value\"]}}]";
            ...
            String starTimeOffset, AnchorTimeType anchorTimeType, TimeOffsetUnits timeOffsetUnits, String endDef)
    {
        ...
        criteria.setFilter(assetIdFilter);
        ...
        if ( startDef != null )
        {
            ...
            FilterDefinition timeFilter = createSelectionDefinitionTimeSelection(startDef,
                    starTimeOffset, anchorTimeType, timeOffsetUnits, endDef, starTimeOffset, anchorTimeType,
                    timeOffsetUnits);
            timeFilter.setAssetFilter(assetIdFilter.getFieldIdentifierValue());

            OsaFilter osaFilter = new OsaFilter();
            osaFilter.setSelectionFilter(timeFilter);
            criteria.setFilter(osaFilter);
        }
    ...
    /**
     * filterDefinition.setStartDefinition
     * filterDefinition.setEndDefinition
     * 
     * @param startDef -
     * @param starTimeOffset -
     ...
     */
    public static FilterDefinition createSelectionDefinitionTimeSelection(String startDef,
            ...
            String endDef, String endTimeOffSet, AnchorTimeType endAnchorTimeType, TimeOffsetUnits endTimeOffsetUnits)
    {
        ...
        filterDefinition.setStartDefinition(createTimeFilter(startDef, starTimeOffset,
                startAnchorTimeType, startTimeOffsetUnits));
        filterDefinition.setEndDefinition(createTimeFilter(endDef, endTimeOffSet, endAnchorTimeType,
                endTimeOffsetUnits));
     ...
     * @return TimeFilter
     */
    public static TimeOrRowFilter createTimeFilter(String dateStr, String timeOffSet,
            AnchorTimeType anchorTimeType, TimeOffsetUnits timeOffsetUnits)
    {

        TimeFilter timeFilter = new TimeFilter();

        timeFilter.setAnchorTimeType(anchorTimeType);
        timeFilter.setTimeOffset(new BigInteger(timeOffSet));
        timeFilter.setTimeOffsetUnits(timeOffsetUnits);
        timeFilter.setAnchorTime(createOsacbmTime(dateStr));

        TimeOrRowFilter timeOrRowFilter = new TimeOrRowFilter();
        timeOrRowFilter.setFilterType(FilterType.TIME_FILTER);
        timeOrRowFilter.setTimeFilter(timeFilter);

        return timeOrRowFilter;
            ...
            String assetId, Object value, OsacbmDataType osacbmDataType, String contentType)
    {
            ...
            putFieldDataCriteria.setFilter(filter);
